...
<div class="col-7">
    <div class="col-sm-12 " style="background-color:#fff; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; border-radius:5px; padding:20px 10px">
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" name="name_coso"  placeholder="Nhập Tên cơ sở">
            </div>
        </div>
        <div class="form-group row">
            <label for="thoigianhoatdong" class="col-sm-3 col-form-label">Thời gian hoạt động</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" name="time_hoatdong"  placeholder="nhập thời gian hoạt động">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" name="time_ketthuc"  placeholder="nhập thời gian kết thúc">
            </div>
        </div>
        <div class="form-group row">
            <label for="thoigianketthuc" class="col-sm-3 col-form-label">Số điện thoại</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" name="phone_coso"  placeholder="nhập số điện thoại" >
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 col-form-label">Hình ảnh(*)</label>
            <div class="col-sm-9 input-group">
                <input type="text" id="image" name="image" class="form-control" placeholder="thêm hình ảnh">
...
<div class=" col-5">
    <div class="col-sm-12" style="background-color:#fff; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; border-radius:5px; padding:5px 10px">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control" name="address_cuthe"  placeholder="địa chỉ cụ thể (địa chỉ nhà)" >
            </div>
        </div>
    </div>
    <!--mô tả -->
