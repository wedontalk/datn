...
<div class="col-7">
    <div class="col-sm-12 " style="background-color:#fff; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; border-radius:5px; padding:20px 10px">
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="name"  placeholder="Nhập tiêu đề sản phẩm">
                @error('title')
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control @error('quantity') is-invalid @enderror" name="quantity"  placeholder="nhập số lượng sản phẩm" >
                @error('quantity')
                    <small class="form-text text-muted">{{$message}}</small>
                @enderror
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control @error('brand') is-invalid @enderror" name="brand"  placeholder="nhập nhãn hiệu sản phẩm" >
                @error('brand')
                    <small class="form-text text-muted">{{$message}}</small>
                @enderror
            </div>
