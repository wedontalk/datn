...
<div class="content">
    <div class="card-header">
        <center><strong class="card-title"><h3>FORM Sửa Thú Cưng</h3></strong></center>
    </div>
...
<div class="col-7">
    <div class="col-sm-12 " style="background-color:#fff; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; border-radius:5px; padding:20px 10px">
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" value="{{$qlthucung->title}}" class="form-control @error('title') is-invalid @enderror" name="title" id="name"  placeholder="Nhập tiêu đề thú cưng">
                @error('title')
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" value="{{$qlthucung->price}}" class="form-control @error('price') is-invalid @enderror" name="price"  placeholder="nhập giá thú cưng">
                @error('price')
                    <small class="form-text text-muted">{{$message}}</small>
                @enderror
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" value="{{$qlthucung->discount}}" class="form-control @error('discount') is-invalid @enderror" name="discount"  placeholder="nhập giá khuyến mãi">
                @error('discount')
                    <small class="form-text text-muted">{{$message}}</small>
                @enderror
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" value="{{$qlthucung->quantity}}" class="form-control @error('quantity') is-invalid @enderror" name="quantity"  placeholder="nhập số lượng thú cưng" >
                @error('quantity')
                    <small class="form-text text-muted">{{$message}}</small>
                @enderror
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" value="{{$qlthucung->age}}" class="form-control @error('age') is-invalid @enderror" name="age"  placeholder="nhập Độ tuổi thú cưng" >
                @error('age')
                    <small class="form-text text-muted">{{$message}}</small>
                @enderror
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" value="{{$qlthucung->status}}" class="form-control @error('status') is-invalid @enderror" name="status"  placeholder="nhập Tình trạng sức khỏe" >
                @error('status')
                    <small class="form-text text-muted">{{$message}}</small>
                @enderror
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" value="{{$qlthucung->render}}" class="form-control @error('render') is-invalid @enderror" name="render"  placeholder="nhập Giống thú cưng" >
                @error('render')
                    <small class="form-text text-muted">{{$message}}</small>
                @enderror
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9 input-group">
                <input type="text" value="{{$qlthucung->image}}" id="image" name="image[]" class="form-control @error('image') is-invalid @enderror" placeholder="thêm hình ảnh">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <select class="form-control" name="id_status">
                    ...
                    <option class="op-text"{{($xet->id == $qlthucung->id_status) ? 'selected':''}} value="{{$xet->id}}">{{$xet->name_type}}</option>
                    @endforeach
                </select>
            </div>
        </div>
...
<div class=" col-5">
    <div class="col-sm-12" style="background-color:#fff; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; border-radius:5px; padding:5px 10px">
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <select class="form-control choose input-sm city  @error('id_menu') is-invalid @enderror" name="id_menu" id="city">
                    ...
                    @foreach($text as $t)
                    <option class="op-text" {{($t->id == $qlthucung->id_menu) ? 'selected':''}} value="{{$t->id}}">{{$t->name_nav}}</option>
                    @endforeach
                </select>
                @error('id_menu')
                    <small class="form-text text-muted">{{$message}}</small>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <select class="form-control input-sm choose province @error('id_category') is-invalid @enderror" name="id_category" id="province">
                    ...
                    <option class="op-text" {{($dmedit->id == $qlthucung->id_category) ? 'selected':''}}  value="{{$dmedit->id}}">{{$dmedit->name}}</option>
                    @endforeach
                </select>
                @error('id_category')
                    <small class="form-text text-muted">{{$message}}</small>
        ...
        <div class="form-group row">
            <div class="col-sm-12">
                <textarea class="form-control" name="description" id="content" rows="2" cols="5">{!! $qlthucung->description !!}</textarea>
            </div>
        </div>
    </div>
    <!--mô tả -->
