                    ...
                    <div class="register-form">
                        ...
                        <div class="group-input">
                            ...
                            <div class="group-input">
                                ...
                                <input type="text" id="username" class="@error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="group-input">
                                <label for="con-pass">Nhập lại Password *</label>
                                <input type="text" id="con-pass" name="password_confirmation" required autocomplete="new-password">
                            </div>
