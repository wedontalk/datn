...
<html lang="en">
    <head>
        ...
        <link href="{{asset('Site/jumbotron-narrow.css')}}" rel="stylesheet">  
        <script src="{{asset('Site/jquery-1.11.3.min.js')}}"></script>
    </head>
    ...
    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="amount"
                               name="amount" type="number" value="{{ intval($total) }}" readonly/>
                    </div>
                    <div class="form-group">
