...
class information extends Model
{
    ...
    protected $fillable = ['id','type_post','title','id_menu','slug_product','brand','id_category','age','status','render','price','discount','quantity','description','image','id_status'];
